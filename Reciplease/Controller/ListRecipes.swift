...
class ListRecipes: UITableViewController{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(titleRecipe: recipe.label, ingredient: recipe.ingredients.map {$0.text}.joined(separator: ", "), timeRecipe: "\(recipe.totalTime)", caloriesRecipe: "\(recipe.calories)", recipeIm: "")
